 ...
 */
public class BannedUrlEntity implements Serializable {
	...
	public BannedUrlEntity() {
	}

	public BannedUrlEntity(String name, String wtype, String wid, String holdup) {
		this.name = name;
		this.wtype = wtype;
		this.wid = wid;
		this.holdup = holdup;
	...
	public String toString() {
		return "BannedUrlEntity [id=" + id + ", name=" + name + ", wtype=" + wtype + ", wid=" + wid + ", holdup="
				+ holdup + "]";
	}
